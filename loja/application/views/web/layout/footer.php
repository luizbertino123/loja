...
<!-- Popper js -->
<script src="<?php echo base_url ('public/js/vendor/popper.min.js'); ?>"></script>
<!-- Bootstrap V4.1.3 Fremwork js -->
<script src="<?php echo base_url ('public/js/bootstrap.min.js'); ?>"></script>
<!-- Ajax Mail js -->
<script src="<?php echo base_url ('public/js/ajax-mail.js'); ?>"></script>
<!-- Meanmenu js -->
...
<!-- Mixitup js -->
<script src="<?php echo base_url ('public/js/jquery.mixitup.min.js'); ?>"></script>
<!-- Countdown -->
...
<!-- Venobox -->
<script src="<?php echo base_url ('public/js/venobox.min.js'); ?>"></script>
<!-- Nice Select js -->
