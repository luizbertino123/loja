                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row">                          
                                ...
                                <div class="form-group col-md-2">
                                    <label>Códiogo do produto</label>
                                    <input type="text" name="produto_codigo" class="form-control border-0" value="<?php echo (isset($produto) ? $produto->produto_codigo : $codigo_gerado); ?>" readonlu="">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <select id="" class="form-control" name="produto_ativo">
                                        ...
                                        <?php if (isset($produto)): ?>
                                            ...
                                            <option value="0" <?php echo ($produto->produto_ativo == 1 ? 'selected' : ''); ?>>Não</option>
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <select id="" class="form-control" name="produto_destaque">
                                        ...
                                        <?php if (isset($produto)): ?>
                                            ...
                                            <option value="0" <?php echo ($produto->produto_destaque == 1 ? 'selected' : ''); ?>>Não</option>
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <select id="" class="form-control" name="produto_controlar_estoque">
                                        ...
                                        <?php if (isset($produto)): ?>
                                            ...
                                            <option value="0" <?php echo ($produto->produto_controlar_estoque == 1 ? 'selected' : ''); ?>>Não</option>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-8">
                                    ...
                                    <div id="erro_uploaded" class="texte-danger"
                                    ...
                                    <?php foreach ($fotos_produto as $foto): ?>
                                        ...
                                        <ul style="list-style: none; display: inline-block">
                                            ...
                                            <li>
                                                ...
                                                <a hred="javascript:(void)" class="btn btn-danger d-block btn-icon mx-auto mb-30 btn-remove"><i class="fas fa-times" ></i></a>
