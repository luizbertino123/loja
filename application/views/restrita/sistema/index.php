                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                                ...
                                <div class="alert alert-sucess alert-dismissible show fade">
                                    <div class="alert-icon"><i class="far fa-check-circle fa-lg"></i></div>
                            ...
                            <div class="form-row">                          
                                ...
                                <div class="form-group col-md-2">
                                    <label>UF</label>
                                    <input type="text" name="sistema_estado" class="form-control uf" value="<?php echo (isset($sistema) ? $sistema->sistema_cidade : set_value('sistema_estado')); ?>" >
                            ...
                            <div class="form-row"
                                 ...
                                 <div class="form-group col-md-2">
                                    ...
                                    <input type="number" name="sistema_produtos_destaques" class="form-control cep" value="<?php echo (isset($sistema) ? $sistema->sistema_produtos_destaques : set_value('sistema_produtos_destaques')); ?>" >
