                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-block">                            
                            ...
                            <a class="bnt bnt-primary float-right" href="<?php echo base_url('restrita/produtos/core'); ?>">Cadastrar</a>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        <?php foreach ($produtos as $produto): ?>
                                            <tr>                                      
                                                ...
                                                <td>
                                                    <a href="<?php echo base_url('restrita/produtos/core/' . $produto->produto_id); ?>" class="btn btn-icon btn-primary mr-2"><i class="far fa-edit"></i></a>
